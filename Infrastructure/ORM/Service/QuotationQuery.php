...
abstract class QuotationQuery extends PurchaseFinanceQuery implements QueryInterface
{
    ...
    public function getRequestForQuotationRemain($id)
    {
        ...
        $qb
            ->innerJoin(
                'ErpDocumentBundle:RequestForQuotation',
                '_requestForQuotation',
                'WITH',
                '_requestForQuotationDetail.purchase = _requestForQuotation'
            )
